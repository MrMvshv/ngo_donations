...
const MONGO_DB_URI = `mongodb+srv://mvshv777:k1rcvnMhffLYtWQb@muckintesting.fok7e.mongodb.net/?retryWrites=true&w=majority&appName=muckinTesting`;
mongoose
...
app.use(function(req, res, next) {
  ...
  res.header("Access-Control-Allow-Origin", "https://potential-system-5j5gjppp7q624x45-3000.app.github.dev");
